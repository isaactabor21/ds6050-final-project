...
into one of these two groups. The deep learning model we intend to use is a CNN, because of the one-toone basis of our dataset and task. In our plan, we believe that false positives and false negatives should be
weighed equally, with maybe a slight preference towards giving false positives (i.e. model predicting
...
**5. Evaluation Plan: What experiments are we planning to run? How do we plan to evaluate
our ML algorithm?**
